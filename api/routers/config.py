...
async def check_database_health() -> dict:
    ...
    """
    try:
        # SurrealDB opens a fresh WebSocket connection per query (no pooling),
        # which takes ~2s on slower hosts. Give it a generous budget so the
        # health check doesn't false-positive "offline" right after startup.
