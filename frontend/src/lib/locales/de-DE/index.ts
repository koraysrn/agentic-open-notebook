...
export const deDE = {
  ...
  agents: {
    title: "Agents",
    subtitle: "Orchestrate research across your knowledge base.",
    goalLabel: "Goal",
    goalPlaceholder: "What should the agent do? e.g. summarize my sources",
    run: "Run",
  ...
  home: {
    ...
    inputPlaceholder: "Ask anything about your knowledge...",
    go: "Go",
    suggested: "Suggested",
    research: "Research",
    study: "Study",
    ...
    pendingApprovals: "{{count}} actions waiting for your approval",
  },
