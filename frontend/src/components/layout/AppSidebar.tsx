...
const getNavigation = (t: TFunction) => [
  {
    ...
    items: [
      ...
      { name: t('navigation.research'), href: '/research', icon: Search, iconClass: undefined },
      { name: t('navigation.study'), href: '/study', icon: GraduationCap, iconClass: undefined },
      { name: t('navigation.create'), href: '/create', icon: Plus, iconClass: undefined },
      { name: t('navigation.workflows'), href: '/workflows', icon: Workflow, iconClass: undefined },
      { name: t('navigation.integrations'), href: '/integrations', icon: Plug, iconClass: undefined },
      { name: t('navigation.activity'), href: '/activity', icon: Activity, iconClass: undefined },
